        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
          ...
          >
            <div className="space-y-2 md:space-y-6">
              <h2 className="text-2xl md:text-3xl md:text-4xl font-bold tracking-tight">실시간 예약 안내</h2>
              <p className="md:text-lg text-primary/60 font-light leading-relaxed">
            ...
            >
              <div className="space-y-2">
                ...
                <h3 className="text-xl md:text-3xl font-bold">네이버 실시간 예약</h3>
              </div>
          ...
          >
            <h2 className="text-2xl font-bold mb-8 md:mb-10">자주 묻는 질문 (FAQ)</h2>

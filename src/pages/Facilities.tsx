    ...
    <div className="pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <motion.div
          ...
          className="mb-20"
        >
          <span className="text-accent text-xs font-bold tracking-[0.4em] uppercase block mb-2 md:mb-4">Experience</span>
        ...
        <motion.div
          ...
          className="mt-16 md:mt-40 overflow-hidden rounded-[3rem] bg-primary text-white"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2">
            {/* 텍스트 콘텐츠 영역: 여백과 간격을 넓혀 고급스러움 강조 */}
            <div className="p-10 md:p-20 py-20 flex flex-col justify-center space-y-10">
              ...
              <p className="md:text-lg text-white/60 font-light md:leading-relaxed">
                제주의 자연과 모던함이 어우러진 메타리움의 공간은 단순한 장소를 넘어 새로운 경험을 제공합니다. 
              ...
              <div className="md:pt-10">
                <a
                  ...
                  className="inline-flex items-center space-x-4 px-6 md:px-12 py-4 md:py-6 bg-white text-primary rounded-full text-sm font-bold tracking-widest hover:bg-secondary transition-all group"
                >
